...
<figure class = 'portrait' >
    ...
    <figcaption>Now, here's a door! The sign says the building is for sale. I wonder what's behind the door...</figcaption>
</figure>
<figure class = 'landscape' >
...
<figure class = 'portrait-wide-caption' >
    <img class="portrait-short" src="{{ "2025/soria/berlanga/DSC06213.jpg" | prepend: site.imageurl | prepend: site.baseurl  }}" alt="Image" />
...
<figure class = 'landscape' >
    <img class-= "narrow" src="{{ "2025/soria/tiermes/tiermes.jpg" | prepend: site.imageurl | prepend: site.baseurl  }}" alt="Image" />
    <figcaption></figcaption>
</figure>
<figure class = 'landscape' >
    <img class = "narrow" src="{{ "2025/soria/tiermes/DSC06253.jpg" | prepend: site.imageurl | prepend: site.baseurl  }}" alt="Image" />
    <figcaption></figcaption>
</figure>
