...
<figure class = "landscape" >
	<img src="{{"2022/06/DSC02536.jpg" | prepend: site.imageurl | prepend: site.baseurl  }}" alt="Image" />
...
<figure class = "default" >
	<img src="{{"/assets/images/2022/06/IMG_0923-1.jpg" | prepend: site.baseurl  }}" alt="Image" />
	<figcaption class="narrow" ><em>Clara - 11 years old</em></figcaption>
</figure>

<figure class = "default" >
	<img class="narrow"  src="{{"/assets/images/2022/06/IMG_0924-rotated.jpg" | prepend: site.baseurl  }}" alt="Image" />
	<figcaption class="narrow" ><em>Clara - 11 years old</em></figcaption>
</figure>

<figure class = "default" >
	<img class="narrow" src="{{"/assets/images/2022/06/IMG_0936-rotated.jpg" | prepend: site.baseurl  }}" alt="Image" />
...
<figure class = "default" >
	<img class="narrow"   src="{{"/assets/images//2022/06/IMG_0934-rotated.jpg" | prepend: site.baseurl  }}" alt="Image" />
...
<figure class = "portrait-wide-caption" >
	<img class="narrow"   src="{{"/assets/images/2022/06/DSC02411-scaled.jpg" | prepend: site.baseurl  }}" alt="Image" />
	<figcaption><em>This is a big freaking mound! Those are the steps to reach the top.</em></figcaption>
</figure>

<figure class = "landscape">
	<img src="{{"/assets/images/2022/06/DSC02401-1.jpg" | prepend: site.baseurl  }}" alt="Image" />
	<figcaption><em></em></figcaption>
</figure>

<figure class = "landscape">
	<img src="{{"/assets/images/2022/06/DSC02396.jpg" | prepend: site.baseurl  }}" alt="Image" />
...
<figure class = "landscape">
	<img src="{{"/assets/images/2022/06/DSC02534-1.jpg" | prepend: site.baseurl  }}" alt="Image" />
	<figcaption><em>The front yard, after Laurie and I attacked the weeds.</em></figcaption>
</figure>

<figure class = "landscape">
	<img src="{{"/assets/images/2022/06/DSC02532.jpg" | prepend: site.baseurl  }}" alt="Image" />
	<figcaption><em>More of the front yard.</em></figcaption>
</figure>


<figure class = "landscape">
	<img src="{{"/assets/images/2022/06/DSC02534.jpg" | prepend: site.baseurl  }}" alt="Image" />
...
<figure class = "landscape">
	<img src="{{"/assets/images/2022/06/IMG_5023.jpg" | prepend: site.baseurl  }}" alt="Image" />
...
<figure class = "portrait">
	<img src="{{"/assets/images/2022/06/IMG_4949-1.jpg" | prepend: site.baseurl  }}" alt="Image" />
	<figcaption><em></em></figcaption>
</figure>
...
<figure class = "portrait">
	<img src="{{"/assets/images/2022/06/IMG_4966-1.jpg" | prepend: site.baseurl  }}" alt="Image" />
...
<figure class = "landscape">
	<img src="{{"/assets/images/2022/06/DSC02425.jpg" | prepend: site.baseurl  }}" alt="Image" />
...
<figure class = "landscape">
	<img src="{{"/assets/images/2022/06/DSC02424.jpg" | prepend: site.baseurl  }}" alt="Image" />
...
<figure class = "landscape">
	<img src="{{"/assets/images/2022/06/DSC02427.jpg" | prepend: site.baseurl  }}" alt="Image" />
	<figcaption></figcaption>
</figure>
...
<figure class = "landscape">
	<img src="{{"/assets/images/2022/06/DSC02436-1.jpg" | prepend: site.baseurl  }}" alt="Image" />
...
<figure class = "landscape">
	<img src="{{"/assets/images/2022/06/DSC02442-1.jpg" | prepend: site.baseurl  }}" alt="Image" />
...
<figure class = "landscape">
	<img src="{{"/assets/images/2022/06/DSC02439-1.jpg" | prepend: site.baseurl  }}" alt="Image" />
...
<figure class = "landscape">
	<img src="{{"/assets/images/2022/06/DSC02453.jpg" | prepend: site.baseurl  }}" alt="Image" />
	<figcaption></figcaption>
</figure>
...
<figure class = "landscape">
	<img src="{{"/assets/images/2022/06/DSC02454.jpg" | prepend: site.baseurl  }}" alt="Image" />
...
<figure class = "landscape">
	<img src="{{"/assets/images/2022/06/IMG_4999.jpg" | prepend: site.baseurl  }}" alt="Image" />
