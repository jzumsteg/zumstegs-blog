...
mermaid: true
layout: post
thumbnail: thumbnail-images/zamora.jpg
summary: Four days in Zamora, Spain, which has become our definite favorite place in all of Spain and one of our favorite places in the world.
---
...
<figure class = "landscape" >
	<img src="{{"zamora/overview/DSC04381.jpg" | prepend: site.imageurl | prepend: site.baseurl | prepend: site.url }}" alt="Zamora" />
...
<figure class = "landscape" >
	<img src="{{"zamora/streets/DSC04193.jpg" | prepend: site.imageurl | prepend: site.baseurl | prepend: site.url }}" alt="Zamora" />
	<figcaption><em>Nothing better than sitting and watching the world go by...</em></figcaption>
</figure>

<figure class = "landscape" >
	<img src="{{"zamora/streets/DSC04341.jpg" | prepend: site.imageurl | prepend: site.baseurl | prepend: site.url }}" alt="Zamora" />
	<figcaption><em>A small plaza.</em></figcaption>
</figure>

<figure class = "landscape" >
	<img src="{{"zamora/streets/DSC04343.jpg" | prepend: site.imageurl | prepend: site.baseurl | prepend: site.url }}" alt="Zamora" />
...
<figure class = "landscape" >
	<img src="{{"zamora/streets/DSC04188.jpg" | prepend: site.imageurl | prepend: site.baseurl | prepend: site.url }}" alt="Zamora" />
	<figcaption><em></em></figcaption>
</figure>

<figure class = "portrait-wide-caption" >
	<img class="narrow" src="{{"zamora/streets/DSC04190.jpg" | prepend: site.imageurl | prepend: site.baseurl | prepend: site.url }}" alt="Zamora" />
...
<figure class = "landscape" >
	<img src="{{"zamora/streets/DSC04359.jpg" | prepend: site.imageurl | prepend: site.baseurl | prepend: site.url }}" alt="Zamora" />
...
<figure class = "landscape" >
	<img src="{{"zamora/streets/DSC04403.jpg" | prepend: site.imageurl | prepend: site.baseurl | prepend: site.url }}" alt="Zamora" />
 ...
 <figure class = "portrait" >
	<img src="{{"zamora/streets/DSC04405.jpg" | prepend: site.imageurl | prepend: site.baseurl | prepend: site.url }}" alt="Zamora" />
	<figcaption><em>Another corner of our favorite Plaza Mayor. </em></figcaption>
</figure>
<figure class = "portrait" >
	<img src="{{"zamora/streets/DSC04397.jpg" | prepend: site.imageurl | prepend: site.baseurl | prepend: site.url }}" alt="Zamora" />
 ...
 <figure class = "portrait" >
	<img src="{{"zamora/streets/DSC04399.jpg" | prepend: site.imageurl | prepend: site.baseurl | prepend: site.url }}" alt="Zamora" />
...
<figure class = "portrait" >
	<img src="{{"zamora/churches/DSC04180.jpg" | prepend: site.imageurl | prepend: site.baseurl | prepend: site.url }}" alt="Zamora" />
...
<figure class = "portrait" >
	<img src="{{"zamora/churches/DSC04179.jpg" | prepend: site.imageurl | prepend: site.baseurl | prepend: site.url }}" alt="Zamora" />
	<figcaption><em></em></figcaption>
</figure>

<figure class = "landscape" >
	<img src="{{"zamora/churches/DSC04215.jpg" | prepend: site.imageurl | prepend: site.baseurl | prepend: site.url }}" alt="Zamora" />
	<figcaption><em>This church, just outside the walls of medieval Zamora, claims to be the oldest church in the city. Another church about a half mile away also claims that title. In fact, both appear in the same records of the city in the mid-eleventh century, so no one knows which is really the oldest. This one, though, has a claim on history: El Cid - the legendary defender of Spain who started to push the Moors out of the country, was knighted in this church sometime in the 12th century. Well, legend says he was; is it true? Lost in the fog of history. </em></figcaption>
</figure>
<figure class = "landscape" >
	<img src="{{"zamora/churches/DSC04231.jpg" | prepend: site.imageurl | prepend: site.baseurl | prepend: site.url }}" alt="Zamora" />
	<figcaption><em>The façade of one of the 22 Romanesque churches in Zamora. </em></figcaption>
</figure>
<figure class = "portrait-wide-caption" >
	<img class="narrow" src="{{"zamora/churches/DSC04221.jpg" | prepend: site.imageurl | prepend: site.baseurl | prepend: site.url }}" alt="Zamora" />
...
<figure class = "portrait-wide-caption" >
	<img class="narrow" src="{{"zamora/churches/DSC04265.jpg" | prepend: site.imageurl | prepend: site.baseurl | prepend: site.url }}" alt="Zamora" />
...
<figure class = "portrait-wide-caption" >
	<img class="narrow" src="{{"zamora/churches/DSC04267.jpg" | prepend: site.imageurl | prepend: site.baseurl | prepend: site.url }}" alt="Zamora" />
...
<figure class = "portrait-wide-caption" >
	<img class="narrow" src="{{"zamora/churches/DSC04317.jpg" | prepend: site.imageurl | prepend: site.baseurl | prepend: site.url }}" alt="Zamora" />
...
<figure class = "landscape" >
	<img src="{{"zamora/churches/DSC04289.jpg" | prepend: site.imageurl | prepend: site.baseurl | prepend: site.url }}" alt="Zamora" />
	<figcaption><em>Saturday afternoon is the big day for weddings&mdash;every church in Zamora will have at least one wedding Saturday afternoons. We love to stand around and watch the activities.</em></figcaption>
</figure>
...
Modernista buildings are marked by organic designs &ndash; flowers and leaves and trees often mark Modernista buildings. In the Zamoran version, the buildings often use color as an architectural element and we can see the first glimmers of art-deco in many of the Modernista buildings.

<figure class = "landscape" >
	<img src="{{"zamora/modernista/DSC04325.jpg" | prepend: site.imageurl | prepend: site.baseurl | prepend: site.url }}" alt="Zamora" />
...
<figure class = "landscape" >
	<img src="{{"zamora/modernista/DSC04184.jpg" | prepend: site.imageurl | prepend: site.baseurl | prepend: site.url }}" alt="Zamora" />
...
<figure class = "landscape" >
	<img src="{{"zamora/modernista/DSC04233.jpg" | prepend: site.imageurl | prepend: site.baseurl | prepend: site.url }}" alt="Zamora" />
	<figcaption><em>Color used as an architecural element. These are ceramic tiles. </em></figcaption>
</figure>

<figure class = "portrait-wide-caption" >
	<img class="narrow" src="{{"zamora/modernista/DSC04249.jpg" | prepend: site.imageurl | prepend: site.baseurl | prepend: site.url }}" alt="Zamora" />
	<figcaption><em>This building shows two common Modernista elements: the organic decoration around the doors and windows on the left, and the Oriel window on the right. There are a couple buildings on which the Oriel window takes up the entire front of the building, with only the ground floor being regular windows and doors. </em></figcaption>
</figure>

<figure class = "portrait" >
	<img src="{{"zamora/modernista/DSC04263.jpg" | prepend: site.imageurl | prepend: site.baseurl | prepend: site.url }}" alt="Zamora" />
