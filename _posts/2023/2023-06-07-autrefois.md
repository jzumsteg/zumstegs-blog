...
<figure >
	<img class = "landscape" src="{{ "autrefois/IMG_5611.jpg" | prepend: site.imageurl | prepend: site.baseurl  }}" alt="Image" />
...
<figure class = "landscape" >
	<img class = "landscape" src="{{ "autrefois/IMG_5612.jpg" | prepend: site.imageurl | prepend: site.baseurl  }}" alt="Image" />
...
<figure class = "portrait" >
	<img class = "portrait" src="{{ "autrefois/DSC04896.jpg" | prepend: site.imageurl | prepend: site.baseurl  }}" alt="Image" />
...
<figure class = "landscape" >
	<img class = "landscape" src="{{ "autrefois/DSC04901.jpg" | prepend: site.imageurl | prepend: site.baseurl  }}" alt="Image" />
...
<figure class = "landscape" >
	<img class = "landscape" src="{{ "autrefois/DSC04927.jpg" | prepend: site.imageurl | prepend: site.baseurl  }}" alt="Image" />
	<figcaption><em>An early-1900s bedroom. </em></figcaption>
</figure>

<figure class = "landscape" >
	<img class = "landscape" src="{{ "autrefois/DSC04905.jpg" | prepend: site.imageurl | prepend: site.baseurl  }}" alt="Image" />
	<figcaption><em>The agricultural section had every farm implement known to man (the 1800s/early-1900s  man). </em></figcaption>
</figure>
<figure class = "landscape" >
	<img class = "landscape" src="{{ "autrefois/DSC04910.jpg" | prepend: site.imageurl | prepend: site.baseurl  }}" alt="Image" />
...
<figure class = "landscape" >
	<img class = "landscape" src="{{ "autrefois/DSC04913.jpg" | prepend: site.imageurl | prepend: site.baseurl  }}" alt="Image" />
	<figcaption><em>A travelling wine press! Same deal as the traveling still.  </em></figcaption>
</figure>

<figure class = "landscape" >
	<img class = "landscape" src="{{ "autrefois/DSC04916.jpg" | prepend: site.imageurl | prepend: site.baseurl  }}" alt="Image" />
...
<figure class = "landscape" >
	<img class = "landscape" src="{{ "autrefois/DSC04920.jpg" | prepend: site.imageurl | prepend: site.baseurl  }}" alt="Image" />
...
<figure class = "landscape" >
	<img class = "landscape" src="{{ "autrefois/DSC04922.jpg" | prepend: site.imageurl | prepend: site.baseurl  }}" alt="Image" />
	<figcaption><em>The scene of a laundry.  </em></figcaption>
</figure>

<figure class = "landscape" >
	<img class = "landscape" src="{{ "autrefois/DSC04928.jpg" | prepend: site.imageurl | prepend: site.baseurl  }}" alt="Image" />
